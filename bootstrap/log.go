 ...
 * @Date:   2022-05-18 20:21:31
 * @Last Modified by: alexander.huang
 * @Last Modified time: 2022-05-18 20:21:31
 */
package bootstrap
...
var (
	...
	options []zap.Option  //configuration items
)
...
func InitializeLog() *zap.Logger {
	...
	if global.App.Config.Log.ShowLine {
		//need AddCaller func to show file name and line
...
func getZapCore() zapcore.Core {
	...
	return zapcore.NewCore(encoder, getLogWiter(), level)
}

func getLogWiter() zapcore.WriteSyncer {
